...
All platforms:
[![noarch](https://img.shields.io/circleci/project/github/conda-forge/smp-feedstock/master.svg?label=noarch)](https://circleci.com/gh/conda-forge/smp-feedstock)
...
Once the `conda-forge` channel has been enabled, `smp` can be installed with:

```
conda install smp
```

It is possible to list all of the versions of `smp` available on your platform with:
